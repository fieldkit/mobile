(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('@angular/forms'), require('@nativescript/angular'), require('nativescript-drop-down')) :
    typeof define === 'function' && define.amd ? define('nativescript-drop-down-angular', ['exports', '@angular/core', '@angular/forms', '@nativescript/angular', 'nativescript-drop-down'], factory) :
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, factory(global['nativescript-drop-down-angular'] = {}, global.ng.core, global.ng.forms, global['ns-angular'], global['ns-drop-down']));
}(this, (function (exports, i0, forms, angular, nativescriptDropDown) { 'use strict';
    ...
    ***************************************************************************** */
    ...
    angular.registerElement("DropDown", function () { return nativescriptDropDown.DropDown; });
    ...
    SelectedIndexValueAccessor.ɵfac = function SelectedIndexValueAccessor_Factory(t) { return new (t || SelectedIndexValueAccessor)(i0.ɵɵdirectiveInject(i0.ElementRef)); };
    SelectedIndexValueAccessor.ɵdir = i0.ɵɵdefineDirective({ type: SelectedIndexValueAccessor, selectors: [["DropDown", "ngModel", ""], ["DropDown", "formControl", ""], ["DropDown", "formControlName", ""], ["dropDown", "ngModel", ""], ["dropDown", "formControl", ""], ["dropDown", "formControlName", ""], ["drop-down", "ngModel", ""], ["drop-down", "formControl", ""], ["drop-down", "formControlName", ""]], hostBindings: function SelectedIndexValueAccessor_HostBindings(rf, ctx) {
            if (rf & 1) {
    ...
    (function () {
        i0.ɵsetClassMetadata(SelectedIndexValueAccessor, [{
                type: i0.Directive,
                args: [{
    ...
    (function () { (typeof ngJitMode === "undefined" || ngJitMode) && i0.ɵɵsetNgModuleScope(DropDownModule, { declarations: [SelectedIndexValueAccessor], imports: [forms.FormsModule], exports: [SelectedIndexValueAccessor, forms.FormsModule] }); })();
    (function () {
...
//# sourceMappingURL=nativescript-drop-down-angular.umd.js.map
