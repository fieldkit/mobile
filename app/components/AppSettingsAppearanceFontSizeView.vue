<template>
    <Page class="page" actionBarHidden="true">
        <GridLayout rows="75,*,55">
            <ScreenHeader row="0" :title="_L('appSettings.appearance.fontSize')" :canNavigateBack="true"
                          :canNavigateSettings="false" :onBack="goBack" class="m-t-10 m-r-20 m-l-20"/>
            <ScrollView row="1" class="m-r-20 m-l-20">
                <GridLayout rows="auto,*" columns="*">
                    <FlexboxLayout alignItems="stretch" flexDirection="row" height="10"
                                   :class="isAndroid ? 'm-r-15 m-l-15' : ''" row="0">
                    ...
                    <Slider :value="currentSettings.appearance.font_size" minValue="0" maxValue="4" opacity="1"
                            selectedBackgroundColor="#f4f5f7" backgroundColor="#d8dce0" color="#1b80c9"
                            @valueChange="selectFontSize" row="0"/>
