<template>
    <Page>
        ...
        <SettingsLayout>
            ...
            />
            <SettingsItemIconText v-show="false" :link="'units'" :text="'appSettings.units.units'" :imageSrc="'~/images/icons_units.png'" />
            <SettingsItemIconText
                v-show="false"
                :link="'permissions'"
            ...
            <SettingsItemIconText :link="'developer'" :text="'appSettings.developer.developer'" :imageSrc="'~/images/icon_developer.png'" />
        </SettingsLayout>
    </Page>
</template>
<script lang="ts">
