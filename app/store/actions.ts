...
export const CONFIGURE_STATION_SET_NETWORKS = "CONFIGURE_STATION_SET_NETWORKS";
export const CONFIGURE_STATION_ADD_NETWORK = "CONFIGURE_STATION_ADD_NETWORK";
export const CONFIGURE_STATION_REMOVE_NETWORK = "CONFIGURE_STATION_REMOVE_NETWORK";
...
export const CHANGE_PORTAL_ENV = "CHANGE_PORTAL_ENV";
export const LOAD_PORTAL_ENVS = "LOAD_PORTAL_ENVS";
