module.exports = {
    ...
    complete: "Complete",
    provideDetails:
        "Provide details about your station location and objective.",
    photosRequired: "Photos (1 required)",
    additionalNotes: "Additional Notes",
    addDetails: "Add details to help your project",
    addNote: "Add Note",
    save: "Save",
    studyObjective: "Study Objective",
    studyObjectiveInstruction: "Tap to add your study objective",
    siteLocation: "Purpose of Site Location",
    siteLocationInstruction: "Tap to add the purpose of your site location",
    siteCriteria: "Site Criteria",
    siteCriteriaInstruction: "Tap to add your site criteria",
    siteDescription: "Site Description",
    siteDescriptionInstruction: "Tap to add your site description",
