module.exports = {
    ...
    complete: "Complete",
    provideDetails:
        "Facilitar información sobre su ubicación de la estación y objetiva.",
    photosRequired: "Fotos (1 requiere)",
    additionalNotes: "Notas adicionales",
    addDetails: "Agrega detalles para ayudar a tu proyecto",
    addNote: "Añadir Nota",
    save: "Guardar",
    studyObjective: "Objetivo del estudio",
    studyObjectiveInstruction: "Pulsar para añadir su estudio objetivo",
    siteLocation: "Objetivo del Sitio Ubicación",
    siteLocationInstruction:
        "Pulsar para añadir el propósito de su ubicación del sitio",
    siteCriteria: "Criterios del sitio",
    siteCriteriaInstruction: "Pulsar para añadir sus criterios de sitio",
    siteDescription: "Descripción del sitio",
    siteDescriptionInstruction: "Pulsar para añadir la descripción del sitio",
